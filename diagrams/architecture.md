...
East US
West Europe
Global failover via Azure Front Door
...
East-West & outbound control
🔹 Scalability
Global load balancing via Front Door origin groups
Regional scaling via Application Gateway autoscaling
...
VM metrics
Diagnostic logs
 Key Architectural Realities (Interview Gold)
🔹 Firewall Placement
...
Multi-region	High availability	Increased cost
...
Real enterprise design (not demo-level)
...
End-to-end TLS with Azure Key Vault integration
